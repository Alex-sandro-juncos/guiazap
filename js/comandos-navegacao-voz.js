...
const _DESTINOS_NAVEGACAO_VOZ = [
  ...
  {
    arquivo: 'talentos.html',
    fala: 'Indo pro Banco de Talentos...',
    gatilhos: ['=banco de talentos', 'banco de talentos', 'ver talentos', 'ver curriculos', 'ver currículos', 'buscar candidato', 'buscar candidatos'],
    palavrasChave: ['banco de talentos', 'talentos', 'curriculos disponiveis']
  },
  {
    arquivo: 'feed.html',
    fala: 'Indo pro feed de novidades...',
    gatilhos: ['=feed', 'ver feed', 'abrir feed', 'novidades', 'ver novidades', 'feed de novidades'],
    palavrasChave: ['feed', 'novidades']
  },
  {
    arquivo: 'videos.html',
    fala: 'Indo pra tela de vídeos...',
    gatilhos: ['=videos', '=vídeos', 'ver videos', 'ver vídeos', 'abrir videos', 'abrir vídeos'],
    palavrasChave: ['videos', 'vídeos']
  },
  {
    arquivo: 'pacotes.html',
    fala: 'Indo pra tela de pacotes...',
    gatilhos: ['=pacotes', 'ver pacotes', 'ver planos', 'quero cadastrar minha empresa', 'cadastrar empresa', 'cadastrar minha empresa', 'quero anunciar', 'ver precos', 'ver preços'],
    palavrasChave: ['pacotes', 'planos', 'cadastrar empresa']
  }
];
